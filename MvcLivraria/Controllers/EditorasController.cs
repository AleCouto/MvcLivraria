...
namespace MvcLivraria.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public EditorasController(MvcLivrariaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EditoraId,NomeEditora,Telefone,Email,Morada,NumeroPorta,Fracao,CodigoPostal,WebSite")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EditoraId,NomeEditora,Telefone,Email,Morada,NumeroPorta,Fracao,CodigoPostal,WebSite")] Editora editora)
        {
        ...
        {
            return _context.Editora.Any(e => e.EditoraId == id);
        }
    }
}
